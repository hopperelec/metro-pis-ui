...
import {type DotMatrixFont, generateOTF, parseImage} from "$lib/components/dot-matrix/index";
...
onMount(() => {
    ...
    image.onload = () => {
        ...
        font = parseImage(image, "abcdefghiklmnoprstuvwxyABCDEFGHIJKLMNOPRSTUWX12,.", 5);
